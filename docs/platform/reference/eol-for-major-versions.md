...
| 3.3.x     | 2026-12-dd      | Automatic upgrade to a supported version    | 2026-12-dd                       | 2026-01-20                      |
| 3.6.x LTS | Date not set    | Automatic upgrade to a supported version    | Date not set                     | 2026-06-dd                      |
