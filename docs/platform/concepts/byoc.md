...
1. [Create a custom cloud](/docs/platform/howto/byoc/custom-cloud/create-custom-cloud) in the Aiven
...
1. **Integrate your cloud account with Aiven** by applying the infrastructure template for
   [AWS](/docs/platform/howto/byoc/custom-cloud/create-aws-custom-cloud#deploy-the-template)
   or
   [Google Cloud](/docs/platform/howto/byoc/custom-cloud/create-google-custom-cloud#deploy-the-template).
