...
-   BYOC is not supported for Google Cloud environments where an IAM policy or organization
    policy requires [Shielded VMs](https://docs.cloud.google.com/compute/shielded-vm/docs/shielded-vm).
