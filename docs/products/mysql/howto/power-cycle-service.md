---
title: Power on/off and delete your Aiven for MySQL® service
...
Power off your Aiven for MySQL® service to release resources and save credits, power it
back on when you need it, or delete it permanently.

<PowerService/>

:::note
When you power on an Aiven for MySQL service, the latest backup is restored and the
binary log (binlog) is replayed to recover the data to the latest available point in time.
:::
