...
1. In the **Restore snapshot** window:
   ...
   1. In the **Indices** field, enter comma-separated list of indices to include in
      the snapshot. They will be closed right before you trigger the restore process.
