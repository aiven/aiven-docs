...
```none
This version of OpenSearch Dashboards (v2.10.0) is incompatible with the following OpenSearch nodes
in your cluster: v2.8.0 @ opensearch-searchdex-1.aiven.local/[${ipaddress}]:9200 (${ip_address})
```
