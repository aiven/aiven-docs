...
Port numbers are extracted from the `EXPOSE` instruction. The following are example
instructions for exposing ports 8000 and 9090:
...
You can define environment variables using the `ENV` instruction. For example:
