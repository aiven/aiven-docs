...
:::tip
You can check how to use Prometheus with Aiven in
...
# TYPE org_apache_cassandra_metrics_Compaction_PendingTasksByTableName_Value_<keyspace>_<table> untyped
org_apache_cassandra_metrics_Compaction_PendingTasksByTableName_Value_<keyspace>_<table>
