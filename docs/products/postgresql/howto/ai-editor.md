---
title: AI editor for Aiven for PostgreSQL®
sidebar_label: AI editor
keywords: ["AI", "Artificial intelligence", "PostgreSQL AI editor", "SQL editor"]
---

import ConsoleIcon from "@site/src/components/ConsoleIcons"

The **Aiven AI editor** lets you write, understand, and run SQL queries in the Aiven Console using natural language.
It combines a SQL editor with an AI assistant that uses your database schema to generate
and explain queries.
...
- **SQL editor:** Write and edit SQL across multiple tabs and run queries to see results
  in the panel below.
...
- The results panel displays your query results below the editor.

## Security and safeguards

The AI editor is designed for safe, controlled access.

- **Read-only execution:** All queries run in read-only mode. The editor blocks data
  definition statements (CREATE, ALTER, DROP) and data modification statements
  (INSERT, UPDATE, DELETE).
- **Single-statement validation:** Only one SQL statement is allowed per execution.
- **Automatic safety checks:** The AI editor validates all generated SQL for safety
  before execution.
- **Timeouts and limits:**
...
The AI editor opens a split view with a SQL editor on the left and the AI Assistant
