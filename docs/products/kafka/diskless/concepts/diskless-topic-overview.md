...
Diskless topics are a feature of Aiven's Kafka clusters that store Kafka topic data in cloud object storage, without writing to local disk.

Diskless topics are available in Kafka services on Aiven Cloud and
...
You can use both diskless and classic Kafka topics in the same Kafka service.
This allows you to:
...
Kafka services, see [Network pricing for Aiven for Apache Kafka®](/docs/products/kafka/concepts/network-pricing).

<RelatedPages/>

- [Create a Kafka cluster](/docs/products/kafka/get-started/create-inkless-service)
- [Diskless topics architecture](/docs/products/kafka/diskless/concepts/diskless-topics-architecture)
