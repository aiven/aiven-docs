...
| `kafka_server_BrokerTopicMetrics_TotalProduceRequestsPerSec_Count`               | Total number of produce requests per second. Note: This metric is collected per host and not per topic. |
