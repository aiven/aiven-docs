  ...
  <tbody>
      ...
      <tr>
        <td>
            ...
            <div className="constraints">
              <ul>
                  <li>enum: <code>classic,classic,consumer,classic,share,classic,streams,classic,consumer,share,classic,consumer,streams,classic,consumer,share,streams</code></li>
              </ul>
            </div>
