...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>flink_version</strong></p><code class="type">string,null</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>number_of_task_slots</strong></p><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>1024</code></li></ul></div></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><p class="name"><strong>privatelink_access.flink</strong></p><code class="type">boolean</code></p></div>
