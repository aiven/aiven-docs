...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div class="param"><p class="name"><strong>pg_stat_monitor_enable</strong></p><p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>pg.pg_stat_monitor.pgsm_max_buckets</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>10</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>pg.pg_stat_monitor.pgsm_enable_query_plan</strong></p><p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div class="param"><p class="name"><strong>timescaledb</strong></p><p><code class="type">object</code></p></div>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>timescaledb.max_background_workers</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>4096</code></li><li>default: <code>16</code></li></ul></div>
