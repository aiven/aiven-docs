...
<table className="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="pg_stat_monitor_enable"><strong>pg_stat_monitor_enable</strong></p><p><code className="type">boolean</code></p><a href="#pg_stat_monitor_enable">#</a></div>
    ...
    <tr>
      <td>
        ...
        <table className="service-param-children">
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="pg_pg_stat_monitor.pgsm_max_buckets"><strong>pg.pg_stat_monitor.pgsm_max_buckets</strong></p><p><code className="type">integer</code></p><a href="#pg_pg_stat_monitor.pgsm_max_buckets">#</a></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>10</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="pg_pg_stat_monitor.pgsm_enable_query_plan"><strong>pg.pg_stat_monitor.pgsm_enable_query_plan</strong></p><p><code className="type">boolean</code></p><a href="#pg_pg_stat_monitor.pgsm_enable_query_plan">#</a></div>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="timescaledb"><strong>timescaledb</strong></p><p><code className="type">object</code></p><a href="#timescaledb">#</a></div>
        ...
        <table className="service-param-children">
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="timescaledb_max_background_workers"><strong>timescaledb.max_background_workers</strong></p><p><code className="type">integer</code></p><a href="#timescaledb_max_background_workers">#</a></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>4096</code></li><li>default: <code>16</code></li></ul></div>
