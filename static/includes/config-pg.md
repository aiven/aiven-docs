...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>enable_ipv6</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>admin_username</strong><code class="type">string,null</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>admin_password</strong><code class="type">string,null</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>backup_hour</strong><code class="type">integer,null</code></p><div class="constraints"><ul><li>max: <code>23</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>backup_minute</strong><code class="type">integer,null</code></p><div class="constraints"><ul><li>max: <code>59</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>pglookout</strong><code class="type">object</code></p><div class="constraints"><ul><li>default: <code>[object Object]</code></li></ul></div></div>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pglookout.max_failover_replication_time_lag</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>10</code></li><li>max: <code>9223372036854776000</code></li><li>default: <code>60</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>pg_service_to_fork_from</strong><code class="type">string,null</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>synchronous_replication</strong><code class="type">string</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>pg_read_replica</strong><code class="type">boolean,null</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>pg_stat_monitor_enable</strong><code class="type">boolean</code></p></div>
        <p class="title">Enable pg_stat_monitor extension if available for the current cluster</p>
        <div class="description"><p>Enable the pg_stat_monitor extension. Enabling this extension will cause the cluster to be restarted.When this extension is enabled, pg_stat_statements results for utility commands are unreliable</p></div>
        <table class="service-param-children">
          <tbody>
          </tbody>
        </table>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>pg_version</strong><code class="type">string,null</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>pgbouncer</strong><code class="type">object</code></p></div>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.server_reset_query_always</strong><code class="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.ignore_startup_parameters</strong><code class="type">array</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.min_pool_size</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>10000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.server_lifetime</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>60</code></li><li>max: <code>86400</code></li><li>default: <code>3600</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.server_idle_timeout</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>86400</code></li><li>default: <code>600</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.autodb_pool_size</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>10000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.autodb_pool_mode</strong><code class="type">string</code></p><div class="constraints"><ul><li>default: <code>transaction</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.autodb_max_db_connections</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>2147483647</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.autodb_idle_timeout</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>86400</code></li><li>default: <code>3600</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pgbouncer.max_prepared_statements</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>3000</code></li><li>default: <code>100</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>recovery_target_time</strong><code class="type">string,null</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>variant</strong><code class="type">string,null</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>private_access.pg</strong><code class="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>private_access.pgbouncer</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>privatelink_access.pg</strong><code class="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>privatelink_access.pgbouncer</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>public_access.pg</strong><code class="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>public_access.pgbouncer</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>pg</strong><code class="type">object</code></p></div>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_freeze_max_age</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>200000000</code></li><li>max: <code>1500000000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_max_workers</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>20</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_naptime</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>86400</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_vacuum_threshold</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>2147483647</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_analyze_threshold</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>2147483647</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_vacuum_scale_factor</strong><code class="type">number</code></p><div class="constraints"><ul><li>max: <code>1</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_analyze_scale_factor</strong><code class="type">number</code></p><div class="constraints"><ul><li>max: <code>1</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_vacuum_cost_delay</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>-1</code></li><li>max: <code>100</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.autovacuum_vacuum_cost_limit</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>-1</code></li><li>max: <code>10000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.bgwriter_delay</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>10</code></li><li>max: <code>10000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.bgwriter_flush_after</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>2048</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.bgwriter_lru_maxpages</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>1073741823</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.bgwriter_lru_multiplier</strong><code class="type">number</code></p><div class="constraints"><ul><li>max: <code>10</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.deadlock_timeout</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>500</code></li><li>max: <code>1800000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.default_toast_compression</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.idle_in_transaction_session_timeout</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>604800000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.jit</strong><code class="type">boolean</code></p></div>
              <p class="title">jit</p>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.log_autovacuum_min_duration</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>-1</code></li><li>max: <code>2147483647</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.log_error_verbosity</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.log_line_prefix</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.log_min_duration_statement</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>-1</code></li><li>max: <code>86400000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.log_temp_files</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>-1</code></li><li>max: <code>2147483647</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_files_per_process</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1000</code></li><li>max: <code>4096</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_prepared_transactions</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>10000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_pred_locks_per_transaction</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>64</code></li><li>max: <code>5120</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_locks_per_transaction</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>64</code></li><li>max: <code>6400</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_slot_wal_keep_size</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>-1</code></li><li>max: <code>2147483647</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_stack_depth</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>2097152</code></li><li>max: <code>6291456</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_standby_archive_delay</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>43200000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_standby_streaming_delay</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>43200000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_replication_slots</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>8</code></li><li>max: <code>64</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_logical_replication_workers</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>4</code></li><li>max: <code>64</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_parallel_workers</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>96</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_parallel_workers_per_gather</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>96</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_worker_processes</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>8</code></li><li>max: <code>96</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.pg_partman_bgw.role</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.pg_partman_bgw.interval</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>3600</code></li><li>max: <code>604800</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.pg_stat_monitor.pgsm_max_buckets</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>10</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.pg_stat_monitor.pgsm_enable_query_plan</strong><code class="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.pg_stat_statements.track</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.temp_file_limit</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>-1</code></li><li>max: <code>2147483647</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.timezone</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.track_activity_query_size</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1024</code></li><li>max: <code>10240</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.track_commit_timestamp</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.track_functions</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.track_io_timing</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.max_wal_senders</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>20</code></li><li>max: <code>64</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.wal_sender_timeout</strong><code class="type">integer</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>pg.wal_writer_delay</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>10</code></li><li>max: <code>200</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>shared_buffers_percentage</strong><code class="type">number</code></p><div class="constraints"><ul><li>min: <code>20</code></li><li>max: <code>60</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>timescaledb</strong><code class="type">object</code></p></div>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>timescaledb.max_background_workers</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>4096</code></li><li>default: <code>16</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>work_mem</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>1024</code></li></ul></div></div>
