...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>private_access.valkey</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>privatelink_access.valkey</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>public_access.valkey</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_maxmemory_policy</strong><code class="type">string,null</code></p><div class="constraints"><ul><li>default: <code>noeviction</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_pubsub_client_output_buffer_limit</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>32</code></li><li>max: <code>512</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_number_of_databases</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>128</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_io_threads</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>32</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_lfu_log_factor</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>100</code></li><li>default: <code>10</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_lfu_decay_time</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>120</code></li><li>default: <code>1</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_ssl</strong><code class="type">boolean</code></p><div class="constraints"><ul><li>default: <code>true</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_timeout</strong><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>31536000</code></li><li>default: <code>300</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_notify_keyspace_events</strong><code class="type">string</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_persistence</strong><code class="type">string</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>valkey_acl_channels_default</strong><code class="type">string</code></p></div>
