  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        ...
        <table className="service-param-children">
          ...
          <tr><td><div className="param"><p className="name"><Link id="private_access_valkey"/><Link to="#private_access_valkey"><strong>private_access.valkey</strong></Link></p><p><code className="type">boolean</code></p></div><p className="title">Allow clients to connect to valkey with a DNS name that always resolves to the service's private IP addresses. Only available in certain network locations</p></td></tr>
          </tbody>
        </table>
      </td>
    </tr>
    <tr>
      <td>
        ...
        <table className="service-param-children">
          ...
          <tr><td><div className="param"><p className="name"><Link id="privatelink_access_valkey"/><Link to="#privatelink_access_valkey"><strong>privatelink_access.valkey</strong></Link></p><p><code className="type">boolean</code></p></div><p className="title">Enable valkey</p></td></tr>
          </tbody>
        </table>
      </td>
    </tr>
    <tr>
      <td>
        ...
        <table className="service-param-children">
          ...
          <tr><td><div className="param"><p className="name"><Link id="public_access_valkey"/><Link to="#public_access_valkey"><strong>public_access.valkey</strong></Link></p><p><code className="type">boolean</code></p></div><p className="title">Allow clients to connect to valkey from the public internet for service nodes that are in a project VPC or another type of private network</p></td></tr>
          </tbody>
        </table>
      </td>
    </tr>
    ...
    <tr>
      <td>
        ...
        <p className="title">Active expire effort</p><div className="description"><p>Valkey reclaims expired keys both when accessed and in the background. The background process scans for expired keys to free memory. Increasing the active-expire-effort setting (default 1, max 10) uses more CPU to reclaim expired keys faster, reducing memory usage but potentially increasing latency.</p></div>
      </td>
    </tr>
    <tr>
      <td>
