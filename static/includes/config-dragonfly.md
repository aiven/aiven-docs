...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><p class="name"><strong>private_access.dragonfly</strong></p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><p class="name"><strong>privatelink_access.dragonfly</strong></p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><p class="name"><strong>public_access.dragonfly</strong></p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>dragonfly_ssl</strong></p><code class="type">boolean</code></p><div class="constraints"><ul><li>default: <code>true</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>cache_mode</strong></p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>dragonfly_persistence</strong></p><code class="type">string</code></p></div>
