...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>private_access.dragonfly</strong></p><p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>privatelink_access.dragonfly</strong></p><p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>public_access.dragonfly</strong></p><p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div class="param"><p class="name"><strong>dragonfly_ssl</strong></p><p><code class="type">boolean</code></p></div><div class="constraints"><ul><li>default: <code>true</code></li></ul></div>
    ...
    <tr>
      <td>
        <div class="param"><p class="name"><strong>cache_mode</strong></p><p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div class="param"><p class="name"><strong>dragonfly_persistence</strong></p><p><code class="type">string</code></p></div>
