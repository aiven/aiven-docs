...
<table className="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="kafka_connect"><a href="#kafka_connect"><strong>kafka_connect</strong></a></p><p><code className="type">object</code></p></div>
        ...
        <table className="service-param-children">
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_connector_client_config_override_policy"><a href="#kafka_connect_connector_client_config_override_policy"><strong>kafka_connect.connector_client_config_override_policy</strong></a></p><p><code className="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_auto_offset_reset"><a href="#kafka_connect_consumer_auto_offset_reset"><strong>kafka_connect.consumer_auto_offset_reset</strong></a></p><p><code className="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_fetch_max_bytes"><a href="#kafka_connect_consumer_fetch_max_bytes"><strong>kafka_connect.consumer_fetch_max_bytes</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>1048576</code></li><li>max: <code>104857600</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_isolation_level"><a href="#kafka_connect_consumer_isolation_level"><strong>kafka_connect.consumer_isolation_level</strong></a></p><p><code className="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_max_poll_interval_ms"><a href="#kafka_connect_consumer_max_poll_interval_ms"><strong>kafka_connect.consumer_max_poll_interval_ms</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_batch_size"><a href="#kafka_connect_producer_batch_size"><strong>kafka_connect.producer_batch_size</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>max: <code>5242880</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_compression_type"><a href="#kafka_connect_producer_compression_type"><strong>kafka_connect.producer_compression_type</strong></a></p><p><code className="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_linger_ms"><a href="#kafka_connect_producer_linger_ms"><strong>kafka_connect.producer_linger_ms</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>max: <code>5000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_max_request_size"><a href="#kafka_connect_producer_max_request_size"><strong>kafka_connect.producer_max_request_size</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>131072</code></li><li>max: <code>67108864</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_session_timeout_ms"><a href="#kafka_connect_session_timeout_ms"><strong>kafka_connect.session_timeout_ms</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="secret_providers"><a href="#secret_providers"><strong>secret_providers</strong></a></p><p><code className="type">array</code></p></div>
