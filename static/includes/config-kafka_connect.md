...
<table className="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="kafka_connect"><strong>kafka_connect</strong></p><p><code className="type">object</code></p><a href="#kafka_connect">#</a></div>
        ...
        <table className="service-param-children">
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_connector_client_config_override_policy"><strong>kafka_connect.connector_client_config_override_policy</strong></p><p><code className="type">string</code></p><a href="#kafka_connect_connector_client_config_override_policy">#</a></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_auto_offset_reset"><strong>kafka_connect.consumer_auto_offset_reset</strong></p><p><code className="type">string</code></p><a href="#kafka_connect_consumer_auto_offset_reset">#</a></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_fetch_max_bytes"><strong>kafka_connect.consumer_fetch_max_bytes</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_consumer_fetch_max_bytes">#</a></div><div className="constraints"><ul><li>min: <code>1048576</code></li><li>max: <code>104857600</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_isolation_level"><strong>kafka_connect.consumer_isolation_level</strong></p><p><code className="type">string</code></p><a href="#kafka_connect_consumer_isolation_level">#</a></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_max_partition_fetch_bytes"><strong>kafka_connect.consumer_max_partition_fetch_bytes</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_consumer_max_partition_fetch_bytes">#</a></div><div className="constraints"><ul><li>min: <code>1048576</code></li><li>max: <code>104857600</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_max_poll_interval_ms"><strong>kafka_connect.consumer_max_poll_interval_ms</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_consumer_max_poll_interval_ms">#</a></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_consumer_max_poll_records"><strong>kafka_connect.consumer_max_poll_records</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_consumer_max_poll_records">#</a></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>10000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_offset_flush_interval_ms"><strong>kafka_connect.offset_flush_interval_ms</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_offset_flush_interval_ms">#</a></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>100000000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_offset_flush_timeout_ms"><strong>kafka_connect.offset_flush_timeout_ms</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_offset_flush_timeout_ms">#</a></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_batch_size"><strong>kafka_connect.producer_batch_size</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_producer_batch_size">#</a></div><div className="constraints"><ul><li>max: <code>5242880</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_buffer_memory"><strong>kafka_connect.producer_buffer_memory</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_producer_buffer_memory">#</a></div><div className="constraints"><ul><li>min: <code>5242880</code></li><li>max: <code>134217728</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_compression_type"><strong>kafka_connect.producer_compression_type</strong></p><p><code className="type">string</code></p><a href="#kafka_connect_producer_compression_type">#</a></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_linger_ms"><strong>kafka_connect.producer_linger_ms</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_producer_linger_ms">#</a></div><div className="constraints"><ul><li>max: <code>5000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_producer_max_request_size"><strong>kafka_connect.producer_max_request_size</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_producer_max_request_size">#</a></div><div className="constraints"><ul><li>min: <code>131072</code></li><li>max: <code>67108864</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_scheduled_rebalance_max_delay_ms"><strong>kafka_connect.scheduled_rebalance_max_delay_ms</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_scheduled_rebalance_max_delay_ms">#</a></div><div className="constraints"><ul><li>max: <code>600000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_connect_session_timeout_ms"><strong>kafka_connect.session_timeout_ms</strong></p><p><code className="type">integer</code></p><a href="#kafka_connect_session_timeout_ms">#</a></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="secret_providers"><strong>secret_providers</strong></p><p><code className="type">array</code></p><a href="#secret_providers">#</a></div>
