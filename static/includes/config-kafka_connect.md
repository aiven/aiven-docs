...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div class="param"><p class="name"><strong>kafka_connect</strong></p><p><code class="type">object</code></p></div>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.connector_client_config_override_policy</strong></p><p><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.consumer_auto_offset_reset</strong></p><p><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.consumer_fetch_max_bytes</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1048576</code></li><li>max: <code>104857600</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.consumer_isolation_level</strong></p><p><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.consumer_max_partition_fetch_bytes</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1048576</code></li><li>max: <code>104857600</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.consumer_max_poll_interval_ms</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.consumer_max_poll_records</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>10000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.offset_flush_interval_ms</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>100000000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.offset_flush_timeout_ms</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.producer_batch_size</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>max: <code>5242880</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.producer_buffer_memory</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>5242880</code></li><li>max: <code>134217728</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.producer_compression_type</strong></p><p><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.producer_linger_ms</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>max: <code>5000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.producer_max_request_size</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>131072</code></li><li>max: <code>67108864</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.scheduled_rebalance_max_delay_ms</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>max: <code>600000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div class="param"><p class="name"><strong>kafka_connect.session_timeout_ms</strong></p><p><code class="type">integer</code></p></div><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>2147483647</code></li></ul></div>
    ...
    <tr>
      <td>
        <div class="param"><p class="name"><strong>secret_providers</strong></p><p><code class="type">array</code></p></div>
