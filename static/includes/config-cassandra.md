...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>cassandra</strong><code class="type">object</code></p></div>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><strong>cassandra.batch_size_warn_threshold_in_kb</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>1000000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>cassandra.batch_size_fail_threshold_in_kb</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>1000000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>cassandra.datacenter</strong><code class="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>cassandra.write_request_timeout_in_ms</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1000</code></li><li>max: <code>10000</code></li></ul></div></div>
          ...
          <tr>
            <td>
              <div><p class="name"><strong>cassandra.read_request_timeout_in_ms</strong><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1000</code></li><li>max: <code>10000</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>migrate_sstableloader</strong><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>service_to_join_with</strong><code class="type">string</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><strong>cassandra_version</strong><code class="type">string,null</code></p></div>
