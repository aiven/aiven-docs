...
<table className="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="kafka_mirrormaker"><a href="#kafka_mirrormaker"><strong>kafka_mirrormaker</strong></a></p><p><code className="type">object</code></p></div>
        ...
        <table className="service-param-children">
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_admin_timeout_ms"><a href="#kafka_mirrormaker_admin_timeout_ms"><strong>kafka_mirrormaker.admin_timeout_ms</strong></a></p><p><code className="type">integer,null</code></p></div><div className="constraints"><ul><li>min: <code>30000</code></li><li>max: <code>1800000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_refresh_topics_enabled"><a href="#kafka_mirrormaker_refresh_topics_enabled"><strong>kafka_mirrormaker.refresh_topics_enabled</strong></a></p><p><code className="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_refresh_topics_interval_seconds"><a href="#kafka_mirrormaker_refresh_topics_interval_seconds"><strong>kafka_mirrormaker.refresh_topics_interval_seconds</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>9223372036854776000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_refresh_groups_enabled"><a href="#kafka_mirrormaker_refresh_groups_enabled"><strong>kafka_mirrormaker.refresh_groups_enabled</strong></a></p><p><code className="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_sync_group_offsets_enabled"><a href="#kafka_mirrormaker_sync_group_offsets_enabled"><strong>kafka_mirrormaker.sync_group_offsets_enabled</strong></a></p><p><code className="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_sync_group_offsets_interval_seconds"><a href="#kafka_mirrormaker_sync_group_offsets_interval_seconds"><strong>kafka_mirrormaker.sync_group_offsets_interval_seconds</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>9223372036854776000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_emit_checkpoints_enabled"><a href="#kafka_mirrormaker_emit_checkpoints_enabled"><strong>kafka_mirrormaker.emit_checkpoints_enabled</strong></a></p><p><code className="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_emit_checkpoints_interval_seconds"><a href="#kafka_mirrormaker_emit_checkpoints_interval_seconds"><strong>kafka_mirrormaker.emit_checkpoints_interval_seconds</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>9223372036854776000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_sync_topic_configs_enabled"><a href="#kafka_mirrormaker_sync_topic_configs_enabled"><strong>kafka_mirrormaker.sync_topic_configs_enabled</strong></a></p><p><code className="type">boolean</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_tasks_max_per_cpu"><a href="#kafka_mirrormaker_tasks_max_per_cpu"><strong>kafka_mirrormaker.tasks_max_per_cpu</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>min: <code>1</code></li><li>max: <code>8</code></li><li>default: <code>1</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_offset_lag_max"><a href="#kafka_mirrormaker_offset_lag_max"><strong>kafka_mirrormaker.offset_lag_max</strong></a></p><p><code className="type">integer</code></p></div><div className="constraints"><ul><li>max: <code>9223372036854776000</code></li></ul></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_groups"><a href="#kafka_mirrormaker_groups"><strong>kafka_mirrormaker.groups</strong></a></p><p><code className="type">string</code></p></div>
          ...
          <tr>
            <td>
              <div className="param"><p className="name" id="kafka_mirrormaker_groups_exclude"><a href="#kafka_mirrormaker_groups_exclude"><strong>kafka_mirrormaker.groups_exclude</strong></a></p><p><code className="type">string</code></p></div>
