...
<table className="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        <div className="param"><p className="name" id="m3aggregator_version"><a href="#m3aggregator_version"><strong>m3aggregator_version</strong></a></p><p><code className="type">string,null</code></p></div>
