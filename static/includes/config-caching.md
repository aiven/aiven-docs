...
<table class="service-param">
  ...
  <tbody>    <tr>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><p class="name"><strong>private_access.redis</strong></p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><p class="name"><strong>privatelink_access.redis</strong></p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        ...
        <table class="service-param-children">
          ...
          <tr>
            <td>
              <div><p class="name"><p class="name"><strong>public_access.redis</strong></p><code class="type">boolean</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_maxmemory_policy</strong></p><code class="type">string,null</code></p><div class="constraints"><ul><li>default: <code>noeviction</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_pubsub_client_output_buffer_limit</strong></p><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>32</code></li><li>max: <code>512</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_number_of_databases</strong></p><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>128</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_io_threads</strong></p><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>32</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_lfu_log_factor</strong></p><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>100</code></li><li>default: <code>10</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_lfu_decay_time</strong></p><code class="type">integer</code></p><div class="constraints"><ul><li>min: <code>1</code></li><li>max: <code>120</code></li><li>default: <code>1</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_ssl</strong></p><code class="type">boolean</code></p><div class="constraints"><ul><li>default: <code>true</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_timeout</strong></p><code class="type">integer</code></p><div class="constraints"><ul><li>max: <code>31536000</code></li><li>default: <code>300</code></li></ul></div></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_notify_keyspace_events</strong></p><code class="type">string</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_persistence</strong></p><code class="type">string</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_acl_channels_default</strong></p><code class="type">string</code></p></div>
    ...
    <tr>
      <td>
        <div><p class="name"><p class="type"><strong>redis_version</strong></p><code class="type">string,null</code></p></div>
