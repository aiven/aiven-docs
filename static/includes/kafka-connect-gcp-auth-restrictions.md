...
Aiven validates Google Cloud external account credentials used in Aiven for Apache Kafka® Connect to prevent unauthorized file access and outbound requests.
